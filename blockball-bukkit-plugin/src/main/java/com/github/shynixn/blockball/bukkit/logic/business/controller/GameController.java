...
import com.github.shynixn.blockball.bukkit.logic.business.commandexecutor.EventCommandExecutor;
import com.github.shynixn.blockball.bukkit.logic.business.commandexecutor.GlobalJoinCommandExecutor;
import com.github.shynixn.blockball.bukkit.logic.business.commandexecutor.GlobalLeaveCommandExecutor;
import com.github.shynixn.blockball.bukkit.logic.business.entity.*;
...
public final class GameController implements com.github.shynixn.blockball.api.business.controller.GameController {
    ...
    final ArenaRepository arenaManager;
    private List<Game> games = new ArrayList<>();

    public GameController() {
        super();
        this.plugin = JavaPlugin.getPlugin(BlockBallPlugin.class);
        this.arenaManager = ArenaRepository.createArenaController(this);
