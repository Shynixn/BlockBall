...
import com.github.shynixn.blockball.bukkit.logic.items.ItemSpawner;
...
class ArenaCommandExecutor extends SCommandExecutor {
            ...
            new DynamicCommandHelper(Config.getInstance().getChatNavigateCommand()) {
                ...
                public void onCommandSend(CommandSender sender, String[] args) {
                    if (sender instanceof Player)
                        SChatMenuManager.getInstance().handleChatMessage((Player) sender, ChatColor.stripColor(this.getText(args)));
                }
            };
        }
    }
    ...
    @PlayerCommand
    public void onPlayerSendCommandevent(Player player, String[] args) {
