 ...
 */
class BallActionEvent(ball: SoccerBall, val player: Player, val inputActionEvent: BallInputActionType, val executeActionType: BallExecuteActionType, val triggerActionType: BallTriggerActionType, val selectedInteractionMeta: SoccerBallMeta.InteractionMeta) :
    BallEvent(ball) {
}