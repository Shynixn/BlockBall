package com.github.shynixn.blockball.business.bukkit.nms.v1_8_R3;
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            if (block.getMaterial() == Material.AIR) {
                final net.minecraft.server.v1_8_R3.Block flag2 = this.world.getType(blockposition.down()).getBlock();
