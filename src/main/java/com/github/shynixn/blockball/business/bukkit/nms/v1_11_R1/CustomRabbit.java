...
public final class CustomRabbit extends EntityRabbit {
    ...
    public CustomRabbit(org.bukkit.World world, boolean special, Ball ball) {
        ...
        try {
            ...
            ignoreFinalField(bField);
            ignoreFinalField(cField);
    ...
    public void move(EnumMoveType enummovetype, double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            boolean flag1 = this.onGround || d1 != d7 && d1 < 0.0D;
            double d10;
            if (this.P > 0.0F && flag1 && (d6 != d0 || d8 != d2)) {
                ...
                d1 = (double) this.P;
                List event1 = this.world.getCubes(this, this.getBoundingBox().b(d6, d1, d8));
                AxisAlignedBB axisalignedbb2 = this.getBoundingBox();
                AxisAlignedBB f = axisalignedbb2.b(d6, 0.0D, d8);
                d10 = d1;
                int k = 0;

                for (int l = event1.size(); k < l; ++k) {
                ...
                for (int j1 = event1.size(); i1 < j1; ++i1) {
                ...
                for (int axisalignedbb4 = event1.size(); k1 < axisalignedbb4; ++k1) {
                ...
                for (int j2 = event1.size(); i2 < j2; ++i2) {
                ...
                for (int l2 = event1.size(); k2 < l2; ++k2) {
                ...
                for (int j3 = event1.size(); i3 < j3; ++i3) {
                ...
                for (int l3 = event1.size(); k3 < l3; ++k3) {
            ...
            if (iblockdata.getMaterial() == Material.AIR) {
                ...
                net.minecraft.server.v1_11_R1.Block var80 = flag2.getBlock();
            ...
            net.minecraft.server.v1_11_R1.Block var86 = iblockdata.getBlock();
            if (d7 != d1) {
            ...
            if (this.positionChanged) {
                ...
                Bukkit.getPluginManager().callEvent(new BallHitWallEvent(ball, var81));
            }
        }
        spigotTimings(false);
    }
