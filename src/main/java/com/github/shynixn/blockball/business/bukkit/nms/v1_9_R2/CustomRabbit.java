package com.github.shynixn.blockball.business.bukkit.nms.v1_9_R2;
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            if (iblockdata.getMaterial() == Material.AIR) {
                ...
                net.minecraft.server.v1_9_R2.Block event1 = flag2.getBlock();
            ...
            net.minecraft.server.v1_9_R2.Block var83 = iblockdata.getBlock();
            if (d7 != d1) {
