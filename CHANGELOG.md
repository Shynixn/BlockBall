...
* #722 Changed `/blockball club join <arena> <club>` to support referee now. Club VS club games can now also be played with a referee. The referee does not need to be a member of any club and just uses "referee" as the club name.
